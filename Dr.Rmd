---
title: "基于人工智能技术在颞叶癫痫$^{18}$F-FDG PET/MRI多模态影像研究" 
subtitle: "博士论文预答辩"
author: 
  - "汇报人：吴环华  \t\n 导师：徐浩&emsp;教授$^{*}$ &nbsp;"
...
## 引言 {.allowframebreaks}
图1（A）2016年全球特发性癫痫的年龄标准化流行率地图和（B）中国国家癫痫预防和控制管理项目覆盖的农村地区
```{r echo=FALSE, out.width=c("100%"), fig.cap="Epilepsy Epidemiology"}
knitr::include_graphics(c("Dr_pic/图1.1.pdf"))
```

\newpage
图1.2 癫痫疾病不同影像检查技术时空分辨率比较^[23]^

---

图1.3 $^{18}$F-FDG PET成像原理图



\newpage
图1.4 18F-FDG PET/MRI多模态融合示例图

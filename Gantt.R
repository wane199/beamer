...
df <- data.frame(
  Stage = c(
    "Chapter1/Review Literature", 
    "Write Paper: Cox-nomogram",
    "Write Paper: PET-radiomics + Machine Learning"
  ),
  Start = c(
    "2023-01-29", 
    "2023-01-20",
...
df <- data.frame(
  ...
  Start = c(
    "2023-01-29", "2023-02-06",
    "2023-12-17",
    "2023-12-21"
  ),
  End = c(
    "2023-02-06", "2023-01-25",
    "2023-01-30", 
    "2023-01-15"
  ),

...
output:
    ...
    theme: metropolis # Pittsburgh # Singapore https://mpetroff.net/files/beamer-theme-matrix/ # $^{18}$F-FDG 
    fonttheme: circles # structurebold
    colortheme: spruce
    fig_caption: yes
    incremental: no
    keep_tex: no
    ...
    slide_level: 2
    toc: yes
    background-image: ./images/AI_brain.png   
section-titles: true
indent: yes
header-includes:
